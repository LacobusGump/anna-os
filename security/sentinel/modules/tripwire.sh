...
# Stripe (DECOY — not real, honeypot only)
STRIPE_SECRET_KEY=sk_decoy_SENTINEL_HONEYPOT_NOT_REAL
STRIPE_WEBHOOK_SECRET=whsec_decoy_SENTINEL_HONEYPOT_NOT_REAL
STRIPE_PRICE_ID=price_decoy_SENTINEL_HONEYPOT
